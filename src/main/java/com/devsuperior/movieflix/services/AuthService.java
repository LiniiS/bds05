...
public class AuthService {
	 ...
	 * <ul><li>Se existir um usuário logado, verifica o email e retorna o username</li>
	 * </ul><li>Se não existir um usuário logado com o email passado, retorna "usuário inválido"</li>
	 * @return username
